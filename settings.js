...
const BOTNAME = '𝚃𝙰𝙺𝚇-𝙾𝙵𝙲™';
const FOOTERNAME = '𝚃𝙰𝙺𝚇-𝙾𝙵𝙲';
global.owner = process.env.OWNER_NUMBER  || '263785192250' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=fIlmGb6R#BP_uhyIttO8uY3eLzUuCubyBicXvVj0c2HxbI-MqqK4' ,
...
LOGO: process.env.LOGO || `https://telegra.ph/file/9c47ad1de078d42eee14e.jpg` ,
POSTGRESQL_URL: process.env.POSTGRESQL_URL === undefined ? 'postgres://vajiratech_user:oSIFl2xmSojMZ0rkzdd0g0W6msuVTpNN@dpg-cpd7fjv109ks73e5gtig-a.frankfurt-postgres.render.com/vajiratech' : process.env.POSTGRESQL_URL,
FOOTER: process.env.FOOTER || '‌𝚃𝙰𝙺𝚇-𝙾𝙵𝙲',    
